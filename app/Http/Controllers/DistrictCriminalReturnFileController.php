...
class DistrictCriminalReturnFileController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('distract_courts.District_criminal.Conclusion.district_criminal_view_return_file',
    ...
    public function create($id)
    {
        ...
        return view('distract_courts.District_criminal.Conclusion.district_criminal_add_return_file',
    ...
    public function document($id)
    {
        ...
        return view('distract_courts.District_criminal.Conclusion.district_criminal_document_return_file', $data);
    }
    ...
    public function documentReadOnly($id)
    {
        ...
        return view('distract_courts.District_criminal.Conclusion.district_criminal_document_return_file_readonly', $data);
    }
    ...
    public function documentPdf($id)
    {
        ...
        return \App\Support\CourtDocumentPdf::stream(
            'distract_courts.District_criminal.Conclusion.district_criminal_document_return_file',
            $data,
