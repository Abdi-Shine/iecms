...
class DistrictExecutionHearingController extends Controller
{
    public function hearingCases(Request $request)
    {
        ...
        return view('Courts.District_execution.hearing.district_execution_view_hearing_Cases', compact('records', 'statuses', 'court', 'hearingStats', 'executionSubCases'));
    }
    ...
    public function hearingScripture(Request $request)
    {
        ...
        return view('Courts.District_execution.hearing.district_execution_view_hearing_scripture', compact('records', 'statuses', 'hearingStats', 'executionSubCases'));
    }
    ...
    public function index()
    {
        ...
        return view('Courts.District_execution.hearing.district_execution_view_schedule', compact('hearings', 'cases', 'courts', 'calendarEvents', 'stats'));
    }
    ...
    public function viewIndex()
    {
        ...
        $executionSubCases = \App\Models\CaseCategory::where('case_name', 'Fulinta')->pluck('sub_case');
        return view('Courts.District_execution.hearing.district_execution_calendar_view', compact('hearings', 'stats', 'executionSubCases'));
    }
    ...
    public function create($caseId = null)
    {
        ...
        return view('Courts.District_execution.hearing.district_execution_hearing_scheduling', compact('cases', 'courts', 'statuses', 'selectedCase', 'hearing', 'caseHearings'));
    }
    ...
    public function documentByCase($caseId)
    {
        ...
        return view('Courts.District_execution.hearing.district_execution_hearing_document',
    ...
    public function createScripture($caseId)
    {
        ...
        $scripture = null;
        return view('Courts.District_execution.hearing.district_execution_add_hearing_scripture', compact('case', 'hearings', 'scripture'));
    }
    ...
    public function scriptureDocument($id)
    {
        ...
        return view('Courts.District_execution.hearing.district_execution_document_hearing_scripture',
    ...
    public function documentPdf($id)
    {
        ...
        return \App\Support\CourtDocumentPdf::stream(
            'Courts.District_execution.hearing.district_execution_hearing_document',
            $data,
    ...
    public function approvalStampDocument($id)
    {
        ...
        return view('Courts.Archive.district_execution_approval_stamp_document',
