...
class DistrictFamilyJudgmentController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('Courts.District_family.Conclusion.district_family_view_Judgment', compact('records', 'statuses', 'stats', 'familySubCases'));
    }
    ...
    public function create($caseId)
    {
        ...
        return view('Courts.District_family.Conclusion.district_family_add_Judgment', compact('case', 'judgment', 'judge'));
    }
    ...
    public function document($id)
    {
        ...
        return view('Courts.District_family.Conclusion.district_family_document_Judgment',
    ...
    public function documentReadOnly($id)
    {
        ...
        return view('Courts.District_family.Conclusion.district_family_document_Judgment_readonly',
    ...
    public function receiptsIndex(Request $request)
    {
        ...
        return view('Courts.District_family.Conclusion.district_family_view_Judgment_taking_parties',
    ...
    public function stampRequestDocument($id)
    {
        ...
        return view('Courts.Archive.district_family_judgment_stamp_document',
