...
class DistrictFamilyReturnFileController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('Courts.District_family.Conclusion.district_family_view_return_file',
    ...
    public function create($id)
    {
        ...
        return view('Courts.District_family.Conclusion.district_family_add_return_file',
    ...
    public function document($id)
    {
        ...
        return view('Courts.District_family.Conclusion.district_family_document_return_file', $data);
    }
    ...
    public function documentReadOnly($id)
    {
        ...
        return view('Courts.District_family.Conclusion.district_family_document_return_file_readonly', $data);
    }
    ...
    public function documentPdf($id)
    {
        ...
        return \App\Support\CourtDocumentPdf::stream(
            'Courts.District_family.Conclusion.district_family_document_return_file',
            $data,
