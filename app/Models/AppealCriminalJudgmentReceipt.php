...
class AppealCriminalJudgmentReceipt extends Model
{
    protected $table    = 'appeal_criminal_judgment_receipts';
    protected $fillable = [
    ...
    {
        return $this->belongsTo(AppealCriminalJudgment::class, 'judgment_id');
    }
