...
class DistrictExecutionJudgmentReceipt extends Model
{
    protected $table    = 'district_execution_judgment_receipts';
    protected $fillable = [
    ...
    {
        return $this->belongsTo(DistrictExecutionJudgment::class, 'judgment_id');
    }
