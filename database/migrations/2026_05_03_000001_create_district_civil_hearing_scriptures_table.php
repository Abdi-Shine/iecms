...
return new class extends Migration {
    ...
    {
        Schema::create('district_civil_hearing_scriptures', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('hearing_id')->references('id')->on('district_civil_hearings')->onDelete('set null');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('district_civil_hearing_scriptures');
    }
};
