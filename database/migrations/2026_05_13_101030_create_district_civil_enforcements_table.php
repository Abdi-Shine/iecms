...
return new class extends Migration {
    ...
    {
        Schema::create('district_civil_enforcements', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('civil_case_id')->unique();
    ...
    {
        Schema::dropIfExists('civil_case_enforcements');
    }
};
