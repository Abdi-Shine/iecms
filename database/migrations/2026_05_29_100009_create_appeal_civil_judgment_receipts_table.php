...
return new class extends Migration {
    ...
    {
        Schema::create('appeal_civil_judgment_receipts', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('judgment_id')->references('id')->on('appeal_civil_judgments')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('appeal_civil_judgment_receipts');
    }
};
