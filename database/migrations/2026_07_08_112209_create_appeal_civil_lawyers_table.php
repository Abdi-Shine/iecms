...
return new class extends Migration
{
    ...
    {
        Schema::create('appeal_civil_lawyers', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('party_id')->references('PID')->on('appeal_civil_parties')->onDelete('set null');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('appeal_civil_lawyers');
    }
};
