...
return new class extends Migration {
    ...
    {
        Schema::create('district_family_lawyers', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('party_id')->references('PID')->on('district_family_parties')->onDelete('set null');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('district_family_lawyers');
    }
};
