...
return new class extends Migration {
    ...
    {
        Schema::create('district_criminal_lawyers', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('party_id')->references('PID')->on('district_criminal_parties')->onDelete('set null');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('district_criminal_lawyers');
    }
};
