...
{
    /**
     * Visibility-only Matrix entries for District Criminal's "Case Parties",
     * "Case Documents", and "Case Lawyers" (routes are gated by "Criminal
     * Case Registration" / "Criminal Case Lawyers" respectively — these exist
    ...
    {
        $modules = [
            'Criminal Case Parties'   => ['view', 'create', 'edit', 'delete'],
            'Criminal Case Documents' => ['view', 'create', 'edit', 'delete'],
            'Criminal Case Lawyers'   => ['view', 'create', 'edit', 'delete'],
        ];

        $mirrorOf = [
            'Criminal Case Parties'   => 'Case Parties',
            'Criminal Case Documents' => 'Case Documents',
            'Criminal Case Lawyers'   => 'Case Lawyers',
        ];
    ...
    {
        $modules = ['Criminal Case Parties', 'Criminal Case Documents', 'Criminal Case Lawyers'];
