...
{
    /**
     * Dedicated permission module for the new City registry, mirroring
     * whichever roles currently hold 'State & Region' so existing role
     * holders get matching access to City out of the box.
     */
    ...
    {
        $ids = DB::table('permissions')->where('module', 'City')->pluck('id');
        DB::table('role_permissions')->whereIn('permission_id', $ids)->delete();
        DB::table('permissions')->where('module', 'City')->delete();
    }
};
