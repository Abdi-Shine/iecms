...
{
    /**
     * Dedicated permission module for the Attorney Department registry,
    ...
    {
        $ids = DB::table('permissions')->where('module', 'Attorney Departments')->pluck('id');
        DB::table('role_permissions')->whereIn('permission_id', $ids)->delete();
        DB::table('permissions')->where('module', 'Attorney Departments')->delete();
    }
};
