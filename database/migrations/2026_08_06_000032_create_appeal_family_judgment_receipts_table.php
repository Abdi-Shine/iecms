...
return new class extends Migration {
    ...
    {
        Schema::create('appeal_family_judgment_receipts', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('judgment_id')->references('id')->on('appeal_family_judgments')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('appeal_family_judgment_receipts');
    }
};
