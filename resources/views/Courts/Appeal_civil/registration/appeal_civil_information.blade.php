    ...
    <div class="p-4 sm:p-6 w-full"
        ...
        <div class="flex items-center justify-between mb-3">
            <div>
                ...
                <p class="text-sm text-neutral-500 mt-0.5">Xogta Guud ee Dacwada Madaniga</p>
            </div>
        ...
        <div class="rounded-2xl shadow-sm border border-neutral-100 overflow-hidden divide-y divide-neutral-100">
                        ...
                        <table class="w-full text-left text-sm">
                            ...
                            <tbody class="divide-y divide-neutral-100">
                                <tr class="hover:bg-neutral-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('appeal-civil-handover.document-pdf', $case->ACID) }}" target="_blank"
                                            class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-semibold border transition-all"
                        ...
                        <table class="w-full text-left text-sm">
                            ...
                            <tbody class="divide-y divide-neutral-100">
                                <tr class="hover:bg-neutral-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('appeal-close-case.document', $case->ACID) }}"
                                            class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-semibold border transition-all"
                                            style="background:rgba(10,40,77,.07);border-color:rgba(10,40,77,.18);color:#0A284D"
                                            onmouseover="this.style.background='#0A284D';this.style.color='white'"
                                            onmouseout="this.style.background='rgba(10,40,77,.07)';this.style.color='#0A284D'">
                    ...
                    <table class="w-full text-left text-sm">
                        <thead>
                            <tr style="background:rgba(82,140,190,0.06)">
                                ...
                                <th class="px-6 py-3 text-xs font-bold uppercase tracking-wider text-neutral-500">Ujeedada
                                </th>
                                <th
                                    class="px-6 py-3 text-xs font-bold uppercase tracking-wider text-neutral-500 text-center">
                                    Fayl</th>
                            ...
                            @forelse($case->hearings->sortBy('hearing_date') as $hearing)
                                ...
                                <tr class="hover:bg-neutral-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-neutral-500">
                                        {{ Str::limit($hearing->hearing_purpose, 40) ?: '—' }}
                                    </td>
                                    <td class="px-6 py-4 text-center">
                                        <a href="{{ route('appeal-hearings.document', $hearing->id) }}"
                                ...
                                <tr class="hover:bg-neutral-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-neutral-600 text-sm">
                                        ...
                                        @if($scripture->hearing_time)
                                            <span
                                                class="text-xs text-neutral-400 block">{{ substr($scripture->hearing_time, 0, 5) }}</span>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4 text-neutral-500 text-sm">{{ $scripture->hearing_type ?: '—' }}</td>

                                    <td class="px-6 py-4 text-center">
                                        <a href="{{ route('appeal-hearings.scripture.document', $scripture->id) }}"
                                    ...
                                    <td class="px-6 py-4">
                                        @if($judgment->judgment_attachment)
                                            <a href="{{ asset('storage/' . $judgment->judgment_attachment) }}" target="_blank"
                                                ...
                                                {{ basename($judgment->judgment_attachment) }}
                                            </a>
                                        @else
            ...
            {{-- ═══ Judgement reviewed Records ═══ --}}
            <div class="bg-white">

                <div class="px-6 py-4 border-b border-neutral-100 flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        <i class="bi bi-gavel text-sm" style="color:#528CBE"></i>
                        <span class="text-xs font-black uppercase tracking-[2px] text-neutral-500">Xaqiijinta Qaadashada
                            Xukunka Dacwada Madaniga</span>
                    </div>
                    <span class="text-xs text-neutral-400 font-medium">{{ $judgments->count() }}
                        {{ Str::plural('record', $judgments->count()) }}</span>
                </div>
                            ...
                            <table class="w-full text-left text-sm">
                                ...
                                <tbody class="divide-y divide-neutral-100">
                                    ...
                                    <tr class="hover:bg-neutral-50 transition-colors">
                                        ...
                                        <td class="px-6 py-4">
                                            <a href="{{ route('appeal-return-file.document', $case->ACID) }}"
                                                class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-semibold border transition-all"
                                                style="background:rgba(10,40,77,.07);border-color:rgba(10,40,77,.18);color:#0A284D"
                                                onmouseover="this.style.background='#0A284D';this.style.color='white'"
                                                onmouseout="this.style.background='rgba(10,40,77,.07)';this.style.color='#0A284D'">
                                ...
                                <tbody class="divide-y divide-neutral-100">
                                    <tr class="hover:bg-neutral-50 transition-colors">
                                        ...
                                        <td class="px-6 py-4 text-neutral-700">
                                            {{ !empty($appeal->appealing_parties) ? implode(', ', (array) $appeal->appealing_parties) : '—' }}
                                        </td>
                                        <td class="px-6 py-4">
