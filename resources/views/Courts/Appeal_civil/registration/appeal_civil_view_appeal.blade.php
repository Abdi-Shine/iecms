...
@section('admin_main_content')
    ...
    <div class="page-wrap">
        ...
        <div class="data-card">
            ...
            {{-- Search & Filter --}}
            <form action="{{ route('appeal-civil-appeal.index') }}" method="GET" class="reg-filter">
                {{-- Page size --}}
                ...
                @if(request()->anyFilled(['search', 'status']))
                    <a href="{{ route('appeal-civil-appeal.index') }}" class="act-btn" title="Clear" style="width:auto;padding:0 .9rem;gap:.4rem;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        @else
                                            <a href="{{ route('appeal-civil-appeal.form', $r->ACID) }}" title="Fur Foomka Rafcaanka"
                                                class="act-btn"
                                        ...
                                        <a href="{{ route('appeal-civil-registration.show', $r->ACID) }}" title="Arag Dacwada Oo Dhan"
                            ...
                            <tr>
                                <td colspan="8">
                                    <div class="empty-state">
                                        ...
                                        <p class="empty-msg">Dacwad rafcaan ah lama helin.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
