{{-- ═══════════════════════════════════════════════════════════
     ...
     Read-only mirror of the original district civil case that
     was appealed, sourced from district_civil_information.blade.php
     ═══════════════════════════════════════════════════════════ --}}
<div class="bg-white">
                        ...
                        <table class="w-full text-left text-sm">
                            ...
                            <tbody class="divide-y divide-neutral-100">
                                <tr class="hover:bg-neutral-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('civil-case-handover.document', $lowerCase->CRID) }}"
                        ...
                        <table class="w-full text-left text-sm">
                            ...
                            <tbody class="divide-y divide-neutral-100">
                                <tr class="hover:bg-neutral-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('close_case.document', $lowerCase->CRID) }}"
                                            class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-semibold border transition-all"
                                            style="background:rgba(10,40,77,.07);border-color:rgba(10,40,77,.18);color:#0A284D">
                                            <i class="bi bi-file-earmark-text"></i> Dukuumintiga
                                        </a>
                        ...
                        <tbody class="divide-y divide-neutral-100">
                            @forelse($lowerCase->hearings->sortBy('hearing_date') as $hearing)
                                <tr class="hover:bg-neutral-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <a href="{{ route('hearings.document', $hearing->id) }}"
                        ...
                        <table class="w-full text-left text-sm">
                            ...
                            <tbody class="divide-y divide-neutral-100">
                                <tr class="hover:bg-neutral-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('ReturnCivilFile.document', $lowerCase->CRID) }}"
                                            class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-semibold border transition-all"
                                            style="background:rgba(10,40,77,.07);border-color:rgba(10,40,77,.18);color:#0A284D">
                                            <i class="bi bi-file-earmark-text"></i> Dukuumintiga
                                        </a>
