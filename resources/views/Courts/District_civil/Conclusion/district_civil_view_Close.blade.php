...
@section('admin_main_content')
    ...
    <div class="page-wrap">
        ...
        <div class="data-card">
            ...
            {{-- Search & Filter --}}
            <form action="{{ route('close_case.index') }}" method="GET" class="reg-filter">
                {{-- Page size --}}
                ...
                @if(request()->anyFilled(['search', 'status', 'sub_case']))
                    <a href="{{ route('close_case.index') }}" class="act-btn" title="Clear" style="width:auto;padding:0 .9rem;gap:.4rem;">
                    ...
                    <tbody>
                        @forelse($records as $i => $r)
                            @php
                                ...
                                $latestJudgment = \App\Models\Judgment::where('civil_case_id', $r->CRID)->orderByDesc('created_at')->first();
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        @else
                                            <a href="{{ route('close_case.form', $r->CRID) }}" title="Fur Foomka Xidhitaanka"
                                                class="act-btn"
                                        ...
                                        {{-- Close case document --}}
                                        @if($latestJudgment)
                                            <a href="{{ route('close_case.document', $r->CRID) }}" title="Dukuumintiga Xidhitaanka"
                                                class="act-btn"
