    ...
    <div class="p-4 sm:p-6 w-full" x-data="{
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex gap-3">
                <a href="{{ route('civil-case-assign.index') }}" class="flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-neutral-600 border border-neutral-200
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden mb-6">
            ...
            <div class="px-6 py-4 border-b border-neutral-100 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    <span class="text-xs text-neutral-400 font-medium">{{ $case->districtCivilPayments->count() }}
                        {{ Str::plural('diiwaan', $case->districtCivilPayments->count()) }}</span>
                    <a href="{{ route('civil-registration.payment-request', $case->CRID) }}"
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm">
                    ...
                    <tbody class="divide-y divide-neutral-100">
                        @forelse($case->districtCivilPayments as $index => $payment)
                            @php
                                $pStatusColors = [
                            ...
                            <tr class="hover:bg-neutral-50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a title="Rasiidka Lacag Bixinta" href="{{ route('civil-registration.payments.receipt', $payment->id) }}" target="_blank"
            ...
            <div class="px-6 py-4 border-t border-neutral-100">
                <p class="text-xs text-neutral-400 font-medium">
                    Muujinaya <span class="font-bold text-neutral-600">{{ $case->districtCivilPayments->count() }}</span>
                    {{ $case->districtCivilPayments->count() === 1 ? 'codsi lacag bixin' : 'codsiyo lacag bixin' }}
                </p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden mb-6">
            ...
            <div class="px-6 py-4 border-b border-neutral-100 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('civil-case-parties.index', ['case_id' => $case->CRID]) }}"
                        class="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-white rounded-lg transition hover:opacity-90"
                        style="background:#528CBE">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden mb-6">
            ...
            <div class="px-6 py-4 border-b border-neutral-100 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('civil-case-documents.index', ['case_id' => $case->CRID]) }}"
                        class="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-white rounded-lg transition hover:opacity-90"
                        style="background:#528CBE">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden mb-6">
            ...
            <div class="px-6 py-4 border-b border-neutral-100 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('civil-case-lawyers.index', ['case_id' => $case->CRID]) }}"
                        class="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-white rounded-lg transition hover:opacity-90"
                        style="background:#528CBE">
