...
@section('admin_main_content')
    ...
    <div class="page-wrap">
        ...
        <div class="data-card">
            ...
            {{-- Search & Filter --}}
            <form action="{{ route('criminal-judgments.receipts') }}" method="GET" class="reg-filter">
                {{-- Page size --}}
                ...
                @if(request()->anyFilled(['search', 'status']))
                    <a href="{{ route('criminal-judgments.receipts') }}" class="act-btn" title="Clear" style="width:auto;padding:0 .9rem;gap:.4rem;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        @endif
                                        <a href="{{ route('criminal-registration.show', $r->CMID) }}" title="Arag Dacwada"
    ...
    <script>
        ...
        function confirmReceipt(judgmentId, partyId) {
            ...
            fetch('/criminal-judgment-receipts/' + judgmentId + '/' + partyId, {
                method: 'POST',
        ...
        function saveEditForm(judgmentId, pid) {
            ...
            fetch('/criminal-judgment-receipts/' + judgmentId + '/' + pid, {
                method: 'POST',
                headers: { 'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content },
                body: fd
            })
