...
@section('admin_main_content')
    ...
    <div class="p-4 sm:p-6 w-full" x-data="assignmentManager">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('criminal-registration.show', $case->CMID) }}"
                ...
                async saveAssignment() {
                    ...
                    try {
                        for (let entry of validEntries) {
                            ...
                            let url = '{{ route("criminal-case-assign.store") }}';
                            if (isUpdate) url = '{{ route("criminal-case-assign.index") }}/' + entry.id;
                            ...
                            const res = await fetch(url, {
                                ...
                                body: JSON.stringify({
                                    criminal_case_id: this.case.CMID,
