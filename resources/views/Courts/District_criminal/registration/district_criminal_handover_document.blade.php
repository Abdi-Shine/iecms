...
<div class="no-print doc-toolbar">
    <div class="doc-toolbar-left">
        ...
        <div>
            <h1 class="doc-toolbar-title">Wareejinta Dacwadda Ciqaabta</h1>
    ...
    <div class="doc-toolbar-actions">
        @if($handover)
            ...
            @endif
            <a href="{{ route('criminal-case-handover.document-pdf', $case->CMID) }}" id="download-btn" class="btn-download" target="_blank">
...
<div class="doc-wrapper">
    <div class="doc-empty">
        ...
        <a href="{{ route('criminal-case-handover.create', $case->CMID) }}" class="btn-download">
...
<div id="handover-doc" class="doc-page-multi">
    ...
    <div class="doc-body">
        ...
        {{-- Intro --}}
        <p class="doc-para">
            Xafiiska Kaalinta Dhexe ee Maxkamada waxa uu wareejiyay galka Dacwadda Ciqaabta
...
function submitSign() {
    ...
    fetch('{{ route("document.sign", ["type" => "criminal_handover", "id" => $handover?->id ?? 0]) }}', {
        method: 'POST',
