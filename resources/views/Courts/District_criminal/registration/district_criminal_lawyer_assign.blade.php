        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('lawyerManager', () => ({
                ...
                async loadAssignments() {
                    try {
                        const res = await fetch(`/criminal-case-lawyers/case/${this.caseId}`);
                ...
                async saveAssignments() {
                    ...
                    try {
                        for (let entry of this.entries) {
                            const url = entry.id ? `/criminal-case-lawyers/${entry.id}` : '/criminal-case-lawyers';
                ...
                async deleteAssignment(id) {
                    ...
                    if (result.isConfirmed) {
                        try {
                            const res = await fetch(`/criminal-case-lawyers/${id}`, {
                                method: 'DELETE',
