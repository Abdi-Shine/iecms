...
@section('admin_main_content')
    ...
    <div class="page-wrap">
        ...
        <div class="page-hd">
            <div class="page-hd-left">
                ...
                <div>
                    ...
                    <p class="page-sub">Maamul iyo diiwaangelinta dhaqan galka xukunnada dacwadaha ciqaabta</p>
                </div>
            </div>
        </div>
        ...
        <div class="data-card">
            ...
            {{-- Search & Filter --}}
            <form action="{{ route('criminal-enforcement.index') }}" method="GET" class="reg-filter">
                {{-- Page size --}}
                ...
                @if(request()->anyFilled(['search', 'status']))
                    <a href="{{ route('criminal-enforcement.index') }}" class="act-btn" title="Clear" style="width:auto;padding:0 .9rem;gap:.4rem;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        @else
                                            <a href="{{ route('criminal-enforcement.form', $r->CMID) }}" title="Fur Foomka Dhaqan Galka"
                                                class="act-btn"
                                        ...
                                        @if($enf)
                                            <a href="{{ route('criminal-enforcement.document', $r->CMID) }}" target="_blank"
                                                title="Dukuumintiga Dhaqan Galka" class="act-btn"
                                                style="background:rgba(10,40,77,.07);color:#0A284D;border:1px solid rgba(10,40,77,.18)">
                                                <i class="bi bi-file-earmark-text"></i>
                                            </a>
                                        @else
                                            <span class="act-btn" title="Dukuuminti ma jirto"
                            ...
                            <tr>
                                <td colspan="9">
                                    <div class="empty-state">
                                        ...
                                        <p class="empty-msg">Dacwad fulinta ah dhaqan gal ah lama helin.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
