...
@section('admin_main_content')
    ...
    <div class="page-wrap">
        ...
        <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:1.5rem">
            ...
            <a href="{{ route('execution-judgments.index') }}" class="btn-back">
                <i class="bi bi-arrow-left"></i> Dib ugu Noqo
            </a>
        </div>

        <form method="POST" action="{{ $judgment ? route('execution-judgments.update', $judgment->id) : route('execution-judgments.store') }}"
            ...
            <div class="sec-card">
                ...
                <div class="sec-bd">
                    ...
                    <div>
                        ...
                        <textarea name="verdict" id="ta_verdict" style="display:none">{{ old('verdict', $judgment->judgment_body ?? '') }}</textarea>
            ...
            <div class="form-actions">
                <a href="{{ route('execution-judgments.index') }}" class="btn-cancel">
