...
@section('admin_main_content')
    ...
    <div class="no-print doc-toolbar">
        <div class="doc-toolbar-left">
            ...
            <div>
                <h1 class="doc-toolbar-title">Soo Celinta Faylka — Dacwadda Fulinta</h1>
        ...
        <div class="doc-toolbar-actions">
            @if($returnFile)
                ...
                @endif
                <a href="{{ route('execution-return-file.document-pdf', $case->ECID) }}" id="download-btn" class="btn-download" target="_blank">
    ...
    @if(!$returnFile)
        <div class="doc-wrapper">
            <div class="doc-empty">
                ...
                <a href="{{ route('execution-return-file.create', $case->ECID) }}" class="btn-download">
    ...
    <script>
        ...
        function submitSign() {
            ...
            fetch('{{ route("document.sign", ["type" => "execution_return_file", "id" => $returnFile?->id ?? 0]) }}', {
                method: 'POST',
