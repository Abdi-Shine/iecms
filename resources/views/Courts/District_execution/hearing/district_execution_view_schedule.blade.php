...
<div class="p-4 sm:p-6 w-full">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('execution-hearings.create') }}"
                        ...
                        <tr class="hover:bg-neutral-50 transition-colors" id="row-{{ $h->id }}">
                            ...
                            <td class="px-5 py-3.5">
                                <div class="flex items-center justify-center gap-1.5">
                                    <a href="{{ route('execution-hearings.document', $h->id) }}" title="View Document"
                                    ...
                                    <button onclick="window.location='{{ route('execution-hearings.edit', $h->id) }}'" title="Edit"
                                            class="w-8 h-8 flex items-center justify-center rounded-lg border border-neutral-200 text-neutral-400 transition-all"
...
$hearingsJson = $hearings->map(function($h) {
    return [
        'id'              => $h->id,
        'execution_case_id'  => $h->execution_case_id,
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const cal = new FullCalendar.Calendar(calEl, {
        ...
        eventClick: function(info) {
            ...
            window.location = '/execution-hearings/' + id + '/edit';
        },
    });
    cal.render();
...
async function deleteHearing(id, btn) {
    ...
    try {
        const res  = await fetch(`/execution-hearings/${id}`, {
