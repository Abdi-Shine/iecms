...
@section('admin_main_content')
    ...
    <div class="page-wrap">
        ...
        <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:1.5rem">
            ...
            <a href="{{ route('family-judgments.index') }}" class="btn-back">
                <i class="bi bi-arrow-left"></i> Dib ugu Noqo
            </a>
        </div>

        <form method="POST" action="{{ $judgment ? route('family-judgments.update', $judgment->id) : route('family-judgments.store') }}"
            ...
            <div class="form-actions">
                <a href="{{ route('family-judgments.index') }}" class="btn-cancel">
