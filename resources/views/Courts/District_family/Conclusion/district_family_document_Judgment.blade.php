...
<div class="no-print doc-toolbar">
    ...
    <div class="doc-toolbar-actions">
        ...
        @if($isStampApproved)
            <a href="{{ route('family-judgments.stamp-request', $judgment->id) }}"
...
<div id="judgment-doc" class="doc-page-multi">
    ...
    <div class="doc-body">
        ...
        <p class="doc-title">XUKUNKA DACWADA QOYSKA</p>
...
function submitSign() {
    ...
    fetch('{{ route("document.sign", ["type" => "family_judgment", "id" => $judgment->id]) }}', {
        method: 'POST',
