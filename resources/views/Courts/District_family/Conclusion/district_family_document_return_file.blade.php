...
@section('admin_main_content')
    ...
    <div class="no-print doc-toolbar">
        ...
        <div class="doc-toolbar-actions">
            @if($returnFile)
                ...
                @endif
                <a href="{{ route('family-return-file.document-pdf', $case->FCID) }}" id="download-btn" class="btn-download" target="_blank">
    ...
    @if(!$returnFile)
        <div class="doc-wrapper">
            <div class="doc-empty">
                ...
                <a href="{{ route('family-return-file.create', $case->FCID) }}" class="btn-download">
    ...
    <script>
        ...
        function submitSign() {
            ...
            fetch('{{ route("document.sign", ["type" => "family_return_file", "id" => $returnFile?->id ?? 0]) }}', {
                method: 'POST',
