...
@section('admin_main_content')
    ...
    <div class="p-4 sm:p-6 w-full" x-data="assignmentManager">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('family-registration.show', $case->FCID) }}"
                ...
                async saveAssignment() {
                    ...
                    try {
                        for (let entry of validEntries) {
                            ...
                            let url = '{{ route("family-case-assign.store") }}';
                            if (isUpdate) url = '{{ route("family-case-assign.index") }}/' + entry.id;
