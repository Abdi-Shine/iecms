...
@section('page_title', 'Wareejinta Dacwadaha Qoyska')
...
@section('admin_main_content')
    ...
    <div class="page-wrap">
        ...
        <div class="data-card">
            ...
            {{-- Search & Filter --}}
            <form action="{{ route('family-transfer.index') }}" method="GET" class="reg-filter">
                {{-- Page size --}}
                ...
                @if(request()->anyFilled(['search', 'status']))
                    <a href="{{ route('family-transfer.index') }}" class="act-btn" title="Clear" style="width:auto;padding:0 .9rem;gap:.4rem;">
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        @if(($isKaaliyeSare ?? false) && $isPending)
                                            <form method="POST" action="{{ route('family-transfer.approve', $trn->id) }}"
                                        ...
                                        @else
                                            <a href="{{ route('family-transfer.form', $r->FCID) }}"
                            ...
                            <tr>
                                <td colspan="9">
                                    <div class="empty-state">
                                        ...
                                        <p class="empty-msg">Dacwad qoyska diyaar u wareejinta lama helin.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
