    ...
    <div class="p-4 sm:p-6 w-full" x-data="{
        deleteAssignment(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    try {
                        const res = await fetch(`{{ route('family-case-assign.index') }}/${id}`, {
                            method: 'DELETE',
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex gap-3">
                <a href="{{ route('family-case-assign.index') }}" class="flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-neutral-600 border border-neutral-200
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden mb-6">
            ...
            <div class="px-6 py-4 border-b border-neutral-100 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('family-registration.payment-request', $case->FCID) }}"
                    ...
                    <tbody class="divide-y divide-neutral-100">
                        @forelse($case->payments as $index => $payment)
                            ...
                            <tr class="hover:bg-neutral-50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a title="Rasiidka Lacag Bixinta" href="{{ route('family-registration.payments.receipt', $payment->id) }}" target="_blank"
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden mb-6">
            ...
            <div class="px-6 py-4 border-b border-neutral-100 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('family-case-parties.index', ['case_id' => $case->FCID]) }}"
                        class="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-white rounded-lg transition hover:opacity-90"
                        style="background:#528CBE">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden mb-6">
            ...
            <div class="px-6 py-4 border-b border-neutral-100 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('family-case-documents.index', ['case_id' => $case->FCID]) }}"
                        class="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-white rounded-lg transition hover:opacity-90"
                        style="background:#528CBE">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden mb-6">
            ...
            <div class="px-6 py-4 border-b border-neutral-100 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('family-case-lawyers.index', ['case_id' => $case->FCID]) }}"
                        class="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-white rounded-lg transition hover:opacity-90"
                        style="background:#528CBE">
