...
@section('page_title', 'Diiwaan Dhaqdhaqaaqa Dacwadaha Qoyska — IECMS')
@section('admin_main_content')
    ...
    <div class="p-4 sm:p-6 w-full">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-2xl font-bold text-neutral-800 tracking-tight">Dhaqdhaqaaqa Dacwadaha Qoyska</h1>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden">
            ...
            <div class="px-6 pt-5 pb-4 border-b border-neutral-100">
                <form action="{{ route('family-registration.handover') }}" method="GET"
                    ...
                    <div class="relative flex-1 min-w-[200px]">
                        ...
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Raadi lambarka kiiska ama nooca dacwadda..."
                            ...
                            <tr class="hover:bg-neutral-50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <div class="flex items-center justify-center gap-2">
                                        <a href="{{ route('family-case-handover.create', $r->FCID) }}"
                                        ...
                                        <a href="{{ route('family-case-handover.document', $r->FCID) }}"
                                        ...
                                        @endif
                                        <a href="{{ route('family-registration.show', $r->FCID) }}"
                            ...
                            <tr>
                                <td colspan="8" class="px-6 py-20 text-center">
                                    <div class="flex flex-col items-center gap-3">
                                        ...
                                        <p class="text-neutral-400 font-medium text-sm">Dacwad qoyska lama helin.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
