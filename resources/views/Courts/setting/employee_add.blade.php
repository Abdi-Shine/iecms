...
@section('admin_main_content')
    ...
    <div class="p-4 sm:p-6 w-full">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('employee.index') }}" class="flex items-center gap-2 px-4 py-2.5 text-sm font-semibold rounded-xl border border-neutral-200
        ...
        <div class="bg-white rounded-2xl overflow-hidden shadow-sm border border-neutral-100">
            ...
            {{-- Header --}}
            <div
                style="background:#528CBE;padding:1.5rem 2rem;display:flex;align-items:center;justify-content:space-between">
                <div style="display:flex;align-items:center;gap:1rem">
                    <div
                        style="width:48px;height:48px;background:rgba(255,255,255,0.12);border-radius:.75rem;display:flex;align-items:center;justify-content:center">
                        <i class="bi bi-person-plus-fill" style="font-size:1.4rem;color:white"></i>
                    </div>
                    <div>
                        <h2 style="font-size:1.15rem;font-weight:800;color:white;margin:0;letter-spacing:-.01em">Staff
                            Details</h2>
                        <p style="font-size:.78rem;color:rgba(255,255,255,.6);margin:0;font-weight:500">Fill in all required
                            fields to add a new member</p>
                    </div>
                </div>
            </div>
            ...
            <div style="padding:2rem 2.25rem">
                <form action="{{ route('employee.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div style="margin-bottom:2rem">
                        <label
                            style="display:block;font-size:.7rem;font-weight:800;color:#374151;text-transform:uppercase;letter-spacing:.07em;margin-bottom:.6rem">
                        ...
                        <label for="photoUpload"
                            ...
                            <span
                                style="font-size:.72rem;font-weight:800;color:#9ca3af;text-transform:uppercase;letter-spacing:.06em"
                                id="photoLabel">Upload Image</span>
                        </label>
                    ...
                    <div style="display:flex;flex-direction:column;gap:1.5rem">
                        ...
                        <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:1.5rem">
                            <div>
                                <label
                                    style="display:block;font-size:.7rem;font-weight:800;color:#374151;text-transform:uppercase;letter-spacing:.07em;margin-bottom:.55rem">
                                ...
                                <div style="position:relative">
                                    ...
                                    <i class="bi bi-hash"
                                        style="position:absolute;right:.85rem;top:50%;transform:translateY(-50%);font-size:.85rem;color:#9ca3af;pointer-events:none"></i>
                                </div>
                            ...
                            <div>
                                ...
                                <div style="position:relative">
                                    ...
                                    <i class="bi bi-chevron-down"
                                        style="position:absolute;right:.85rem;top:50%;transform:translateY(-50%);font-size:.7rem;color:#9ca3af;pointer-events:none"></i>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:1.5rem">
                            ...
                            <div>
                                <label
                                    style="display:block;font-size:.7rem;font-weight:800;color:#374151;text-transform:uppercase;letter-spacing:.07em;margin-bottom:.55rem">
                                    Institution Assignment <span style="color:#ef4444">*</span>
                                </label>
                                <div style="position:relative">
                    ...
                    {{-- Form Actions --}}
                    <div
                        style="margin-top:2rem;padding-top:1.5rem;border-top:1px solid #f3f4f6;display:flex;align-items:center;justify-content:space-between">
