...
@section('admin_main_content')
    ...
    <div class="page-wrap">
        ...
        <div class="data-card">
            ...
            {{-- Search & Filter --}}
            <form action="{{ route('appeal-close-case.index') }}" method="GET" class="reg-filter">
                {{-- Page size --}}
                ...
                @if(request()->anyFilled(['search', 'status']))
                    <a href="{{ route('appeal-close-case.index') }}" class="act-btn" title="Clear" style="width:auto;padding:0 .9rem;gap:.4rem;">
                    ...
                    <tbody>
                        @forelse($records as $i => $r)
                            @php
                                ...
                                $latestJudgment = \App\Models\Judgment::where('civil_case_id', $r->ACID)->orderByDesc('created_at')->first();
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        @else
                                            <a href="{{ route('appeal-close-case.form', $r->ACID) }}" title="Fur Foomka Xidhitaanka"
                                                class="act-btn"
                                        ...
                                        {{-- Close case document --}}
                                        @if($latestJudgment)
                                            <a href="{{ route('appeal-close-case.document', $r->ACID) }}" title="Dukuumintiga Xidhitaanka"
                                                class="act-btn"
                            ...
                            <tr>
                                <td colspan="9">
                                    <div class="empty-state">
                                        ...
                                        <p class="empty-msg">Dacwad la xidhay lama helin.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
