...
@section('admin_main_content')
    ...
    <div class="page-wrap">
        ...
        <div style="display:flex;gap:0;border-bottom:2px solid #e5e7eb;margin-bottom:1.5rem">
            <a href="{{ route('appeal-transfer.index') }}"
        ...
        <div class="data-card">
            ...
            {{-- Search & Filter --}}
            <form action="{{ route('appeal-transfer.index') }}" method="GET" class="reg-filter">
                {{-- Page size --}}
                ...
                @if(request()->anyFilled(['search', 'status']))
                    <a href="{{ route('appeal-transfer.index') }}" class="act-btn" title="Clear" style="width:auto;padding:0 .9rem;gap:.4rem;">
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        @if(($isKaaliyeSare ?? false) && $isPending)
                                            <form method="POST" action="{{ route('appeal-transfer.approve', $trn->id) }}"
                                        ...
                                        @else
                                            <a href="{{ route('appeal-transfer.form', $r->ACID) }}"
