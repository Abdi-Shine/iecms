...
@section('admin_main_content')
    ...
    <div class="p-4 sm:p-6 w-full">
        ...
        <form method="POST" action="{{ route('appeal-criminal-close-case.store') }}"
            ...
            <div style="display:flex;align-items:center;justify-content:space-between;padding-bottom:1.5rem">
                <a href="{{ route('appeal-criminal-close-case.index') }}" style="padding:.6rem 1.5rem;font-size:.85rem;font-weight:600;color:#374151;border:1.5px solid #e5e7eb;
