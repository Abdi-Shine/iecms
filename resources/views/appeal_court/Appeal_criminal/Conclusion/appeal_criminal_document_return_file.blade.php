    ...
    <div class="no-print doc-toolbar">
        ...
        <div class="doc-toolbar-actions">
            @if($returnFile)
                ...
                @endif
                <a href="{{ route('appeal-criminal-return-file.document-pdf', $case->ACMID) }}" id="download-btn" class="btn-download" target="_blank">
    ...
    @if(!$returnFile)
        <div class="doc-wrapper">
            <div class="doc-empty">
                ...
                <a href="{{ route('appeal-criminal-return-file.create', $case->ACMID) }}" class="btn-download">
