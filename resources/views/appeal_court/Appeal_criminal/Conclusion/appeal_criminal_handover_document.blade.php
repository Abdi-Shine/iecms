...
<div class="no-print doc-toolbar">
    ...
    <div class="doc-toolbar-actions">
        @if($handover)
            ...
            @endif
            <a href="{{ route('appeal-criminal-handover.document-pdf', $case->ACMID) }}" id="download-btn" class="btn-download" target="_blank">
...
<div class="doc-wrapper">
    <div class="doc-empty">
        ...
        <a href="{{ route('appeal-criminal-handover.create', $case->ACMID) }}" class="btn-download">
...
function submitSign() {
    ...
    fetch('{{ route("document.sign", ["type" => "handover", "id" => $handover?->id ?? 0]) }}', {
        method: 'POST',
