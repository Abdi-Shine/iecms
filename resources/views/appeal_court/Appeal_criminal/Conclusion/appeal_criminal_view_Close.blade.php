...
@section('admin_main_content')
    ...
    <div class="page-wrap">
        ...
        <div class="data-card">
            ...
            {{-- Search & Filter --}}
            <form action="{{ route('appeal-criminal-close-case.index') }}" method="GET" class="reg-filter">
                {{-- Page size --}}
                ...
                @if(request()->anyFilled(['search', 'status']))
                    <a href="{{ route('appeal-criminal-close-case.index') }}" class="act-btn" title="Clear" style="width:auto;padding:0 .9rem;gap:.4rem;">
                    ...
                    <tbody>
                        @forelse($records as $i => $r)
                            @php
                                ...
                                $latestJudgment = \App\Models\Judgment::where('criminal_case_id', $r->ACMID)->orderByDesc('created_at')->first();
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        @else
                                            <a href="{{ route('appeal-criminal-close-case.form', $r->ACMID) }}" title="Fur Foomka Xidhitaanka"
                                                class="act-btn"
                                        ...
                                        {{-- Close case document --}}
                                        @if($latestJudgment)
                                            <a href="{{ route('appeal-criminal-close-case.document', $r->ACMID) }}" title="Dukuumintiga Xidhitaanka"
                                                class="act-btn"
