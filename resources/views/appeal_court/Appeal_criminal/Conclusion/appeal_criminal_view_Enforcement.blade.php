...
@section('admin_main_content')
    ...
    <div class="page-wrap">
        ...
        <div class="data-card">
            ...
            {{-- Search & Filter --}}
            <form action="{{ route('appeal-criminal-enforcement.index') }}" method="GET" class="reg-filter">
                {{-- Page size --}}
                ...
                @if(request()->anyFilled(['search', 'status']))
                    <a href="{{ route('appeal-criminal-enforcement.index') }}" class="act-btn" title="Clear" style="width:auto;padding:0 .9rem;gap:.4rem;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        @else
                                            <a href="{{ route('appeal-criminal-enforcement.form', $r->ACMID) }}" title="Fur Foomka Dhaqan Galka"
                                                class="act-btn"
