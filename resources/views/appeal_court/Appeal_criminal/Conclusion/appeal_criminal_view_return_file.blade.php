    ...
    <div class="p-4 sm:p-6 w-full">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden">
            ...
            <div class="px-6 pt-5 pb-4 border-b border-neutral-100">
                <form action="{{ route('appeal-criminal-return-file.index') }}" method="GET"
                            ...
                            <tr class="hover:bg-neutral-50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <a href="{{ route('appeal-criminal-return-file.create', $r->ACMID) }}"
                                        ...
                                        {{-- Document button --}}
                                        @if($rf)
                                            <a href="{{ route('appeal-criminal-return-file.document', $r->ACMID) }}"
                            ...
                            <tr>
                                <td colspan="9" class="px-6 py-20 text-center">
                                    <div class="flex flex-col items-center gap-3">
                                        ...
                                        <p class="text-neutral-400 font-medium text-sm">Dacwad ciqaab ah lama helin.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
