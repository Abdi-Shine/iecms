                ...
                async saveAssignment() {
                    ...
                    try {
                        for (let entry of validEntries) {
                            ...
                            let url = '{{ route("appeal-criminal-assign.store") }}';
                            if (isUpdate) url = '{{ route("appeal-criminal-assign.index") }}/' + entry.id;
                            ...
                            const res = await fetch(url, {
                                ...
                                body: JSON.stringify({
                                    criminal_case_id: this.case.CRID,
                ...
                async deleteAssignment(id) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            try {
                                const res = await fetch(`{{ route('appeal-criminal-assign.index') }}/${id}`, {
                                    method: 'DELETE',
