    ...
    <div class="p-4 sm:p-6 w-full">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden">
            ...
            <div class="px-6 pt-5 pb-4 border-b border-neutral-100">
                <form action="{{ route('appeal-criminal-assign.index') }}" method="GET"
                    ...
                    <div class="relative flex-1 min-w-[200px]">
                        ...
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Raadi lambarka kiiska ama nooca dacwadda..." class="w-full pl-10 pr-4 py-2.5 text-sm border border-neutral-200 rounded-xl bg-neutral-50
                    ...
                    <tbody class="divide-y divide-neutral-100">
                        @forelse($cases as $index => $c)
                            <tr class="hover:bg-neutral-50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <span class="text-xs font-bold text-neutral-400">{{ str_pad($cases->firstItem() + $index, 2, '0', STR_PAD_LEFT) }}</span>
                                </td>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center gap-2">
                                        <a href="{{ route('appeal-criminal-assign.add', $c->ACMID) }}" title="Xukumi Garsoore"
                                        ...
                                        <a href="{{ route('appeal-criminal-registration.show', $c->ACMID) }}" title="Arag Dacwadda"
                                            class="w-8 h-8 flex items-center justify-center rounded-lg border border-neutral-200 text-neutral-400 transition-all"
                                            onmouseover="this.style.background='#528CBE';this.style.borderColor='#528CBE';this.style.color='white'"
                                            onmouseout="this.style.background='';this.style.borderColor='';this.style.color=''">
