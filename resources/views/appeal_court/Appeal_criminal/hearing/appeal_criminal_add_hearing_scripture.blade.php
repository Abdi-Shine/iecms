...
@section('admin_main_content')
    ...
    <div class="page-wrap">
        ...
        <div class="page-hd">
            ...
            <a href="{{ route('appeal-criminal-hearings.scripture') }}" class="btn-back">
                <i class="bi bi-arrow-left"></i> Dib ugu Noqo
            </a>
        </div>

        <form method="POST"
            action="{{ $scripture ? route('appeal-criminal-hearings.scripture.update', $scripture->id) : route('appeal-criminal-hearings.scripture.store') }}">
            @csrf
            ...
            <div class="form-actions">
                <a href="{{ route('appeal-criminal-hearings.scripture') }}" class="btn-cancel">
