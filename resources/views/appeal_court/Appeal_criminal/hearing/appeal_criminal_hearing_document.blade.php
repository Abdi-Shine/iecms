...
@section('admin_main_content')
    ...
    <div class="no-print doc-toolbar">
        <div class="doc-toolbar-left">
            ...
            <div>
                <h1 class="doc-toolbar-title">Mudeeyn Dacwad Rafcaan Ah</h1>
                <p class="doc-toolbar-sub">
                    Mudeeyn Dacwad Rafcaan Ah · <span>{{ $case->FileNo }}</span>
                </p>
            </div>
        </div>
        <div class="doc-toolbar-actions">
            ...
            @endif
            <a href="{{ route('appeal-criminal-hearings.document-pdf', $hearing->id) }}" id="download-btn" class="btn-download" target="_blank">
    ...
    <div class="doc-wrapper" id="doc-wrapper">
        <div id="hearing-doc" class="doc-page-multi">
            ...
            <div class="doc-body">
                ...
                {{-- Title --}}
                <p class="doc-title">UJEEDDO: MUDEYN DACWAD RAFCAAN AH.</p>
    ...
    <script>
        ...
        function submitSign() {
            ...
            fetch('{{ route("document.sign", ["type" => "appeal_hearing", "id" => $hearing->id]) }}', {
                method: 'POST',
