...
@section('page_title', 'Courts Integration — Transfer Cases')
...
@section('admin_main_content')
    ...
    <div class="page-wrap">
        ...
        <div class="page-hd">
            <div class="page-hd-left">
                ...
                <div>
                    ...
                    <p class="page-sub">Maamul iyo diiwaangelinta wareejinta dacwadaha ciqaabta</p>
                </div>
            </div>
        </div>
        ...
        <div style="display:flex;gap:0;border-bottom:2px solid #e5e7eb;margin-bottom:1.5rem">
            <a href="{{ route('appeal-criminal-transfer.index') }}"
        ...
        <div class="data-card">
            ...
            {{-- Search & Filter --}}
            <form action="{{ route('appeal-criminal-transfer.index') }}" method="GET" class="reg-filter">
                {{-- Page size --}}
                ...
                @if(request()->anyFilled(['search', 'status']))
                    <a href="{{ route('appeal-criminal-transfer.index') }}" class="act-btn" title="Clear" style="width:auto;padding:0 .9rem;gap:.4rem;">
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        @if(($isKaaliyeSare ?? false) && $isPending)
                                            <form method="POST" action="{{ route('appeal-criminal-transfer.approve', $trn->id) }}"
                                        ...
                                        @else
                                            <a href="{{ route('appeal-criminal-transfer.form', $r->ACMID) }}"
