        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('lawyerManager', () => ({
                ...
                async loadAssignments() {
                    try {
                        const res = await fetch(`/appeal-criminal-lawyers/case/${this.caseId}`);
                ...
                editAssignment(assign) {
                    ...
                    this.entries = [{
                        id: assign.id,
                        criminal_case_id: assign.criminal_case_id,
                ...
                async saveAssignments() {
                    ...
                    try {
                        for (let entry of this.entries) {
                            const url = entry.id ? `/appeal-criminal-lawyers/${entry.id}` : '/appeal-criminal-lawyers';
                ...
                async deleteAssignment(id) {
                    ...
                    if (result.isConfirmed) {
                        try {
                            const res = await fetch(`/appeal-criminal-lawyers/${id}`, {
                                method: 'DELETE',
