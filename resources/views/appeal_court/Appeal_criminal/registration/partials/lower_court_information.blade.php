{{-- ═══════════════════════════════════════════════════════════
     ...
     Read-only mirror of the original district criminal case that
                        ...
                        <table class="w-full text-left text-sm">
                            ...
                            <tbody class="divide-y divide-neutral-100">
                                <tr class="hover:bg-neutral-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('criminal-case-handover.document', $lowerCase->CMID) }}"
                        ...
                        <table class="w-full text-left text-sm">
                            ...
                            <tbody class="divide-y divide-neutral-100">
                                <tr class="hover:bg-neutral-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('criminal-close-case.document', $lowerCase->CMID) }}"
                                            class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-semibold border transition-all"
                                            style="background:rgba(10,40,77,.07);border-color:rgba(10,40,77,.18);color:#0A284D">
                                            <i class="bi bi-file-earmark-text"></i> Dukuumintiga
                                        </a>
                        ...
                        <tbody class="divide-y divide-neutral-100">
                            @forelse($lowerCase->hearings->sortBy('hearing_date') as $hearing)
                                <tr class="hover:bg-neutral-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <a href="{{ route('criminal-hearings.document', $hearing->id) }}"
                        ...
                        <table class="w-full text-left text-sm">
                            ...
                            <tbody class="divide-y divide-neutral-100">
                                <tr class="hover:bg-neutral-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('criminal-return-file.document', $lowerCase->CMID) }}"
                                            class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-semibold border transition-all"
                                            style="background:rgba(10,40,77,.07);border-color:rgba(10,40,77,.18);color:#0A284D">
                                            <i class="bi bi-file-earmark-text"></i> Dukuumintiga
                                        </a>
