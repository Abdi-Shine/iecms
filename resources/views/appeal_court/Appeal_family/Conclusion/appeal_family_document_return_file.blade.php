...
@section('admin_main_content')
    ...
    <div class="no-print doc-toolbar">
        <div class="doc-toolbar-left">
            ...
            <div>
                <h1 class="doc-toolbar-title">Soo Celinta Faylka — Dacwadda Qoyska</h1>
        ...
        <div class="doc-toolbar-actions">
            @if($returnFile)
                ...
                @endif
                <a href="{{ route('appeal-family-return-file.document-pdf', $case->AFCID) }}" id="download-btn" class="btn-download" target="_blank">
    ...
    @if(!$returnFile)
        <div class="doc-wrapper">
            <div class="doc-empty">
                ...
                <a href="{{ route('appeal-family-return-file.create', $case->AFCID) }}" class="btn-download">
        ...
        <div class="doc-wrapper" id="doc-wrapper">
            <div id="return-file-doc" class="doc-page-multi">
                ...
                <div class="doc-body">
                    ...
                    {{-- Subject --}}
                    <p class="doc-title">Ujeedo: Warqadda Soo Celinta Faylka Dacwadda Qoyska</p>

                    {{-- Intro --}}
                    <p class="doc-para">
                        Maxkamadu waxay soo celisay Faylka Dacwadda Qoyska
