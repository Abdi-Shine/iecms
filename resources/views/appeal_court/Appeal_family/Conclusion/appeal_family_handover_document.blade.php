...
<div class="no-print doc-toolbar">
    <div class="doc-toolbar-left">
        ...
        <div>
            <h1 class="doc-toolbar-title">Wareejinta Dacwadda Qoyska</h1>
    ...
    <div class="doc-toolbar-actions">
        @if($handover)
            ...
            @endif
            <a href="{{ route('appeal-family-handover.document-pdf', $case->AFCID) }}" id="download-btn" class="btn-download" target="_blank">
...
<div class="doc-wrapper">
    <div class="doc-empty">
        ...
        <a href="{{ route('appeal-family-handover.create', $case->AFCID) }}" class="btn-download">
...
<div id="handover-doc" class="doc-page-multi">
    ...
    <div class="doc-body">
        ...
        {{-- Intro --}}
        <p class="doc-para">
            Xafiiska Kaalinta Dhexe ee Maxkamada waxa uu wareejiyay galka Dacwadda Qoyska
