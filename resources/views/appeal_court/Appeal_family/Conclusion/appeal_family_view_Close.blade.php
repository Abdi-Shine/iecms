...
@section('admin_main_content')
    ...
    <div class="page-wrap">
        ...
        <div class="data-card">
            ...
            {{-- Search & Filter --}}
            <form action="{{ route('appeal-family-close-case.index') }}" method="GET" class="reg-filter">
                {{-- Page size --}}
                ...
                @if(request()->anyFilled(['search', 'status']))
                    <a href="{{ route('appeal-family-close-case.index') }}" class="act-btn" title="Clear" style="width:auto;padding:0 .9rem;gap:.4rem;">
                    ...
                    <tbody>
                        @forelse($records as $i => $r)
                            @php
                                ...
                                $latestJudgment = \App\Models\Judgment::where('family_case_id', $r->AFCID)->orderByDesc('created_at')->first();
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        @else
                                            <a href="{{ route('appeal-family-close-case.form', $r->AFCID) }}" title="Fur Foomka Xidhitaanka"
                                                class="act-btn"
                                        ...
                                        {{-- Close case document --}}
                                        @if($latestJudgment)
                                            <a href="{{ route('appeal-family-close-case.document', $r->AFCID) }}" title="Dukuumintiga Xidhitaanka"
                                                class="act-btn"
