    ...
    <div class="p-4 sm:p-6 w-full">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden">
            ...
            <div class="px-6 pt-5 pb-4 border-b border-neutral-100">
                <form action="{{ route('appeal-family-return-file.index') }}" method="GET"
                            ...
                            <tr class="hover:bg-neutral-50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <a href="{{ route('appeal-family-return-file.create', $r->AFCID) }}"
                                        ...
                                        {{-- Document button --}}
                                        @if($rf)
                                            <a href="{{ route('appeal-family-return-file.document', $r->AFCID) }}"
