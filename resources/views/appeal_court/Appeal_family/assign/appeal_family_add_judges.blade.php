                ...
                async saveAssignment() {
                    ...
                    try {
                        for (let entry of validEntries) {
                            ...
                            let url = '{{ route("appeal-family-assign.store") }}';
                            if (isUpdate) url = '{{ route("appeal-family-assign.index") }}/' + entry.id;
                ...
                async deleteAssignment(id) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            try {
                                const res = await fetch(`{{ route('appeal-family-assign.index') }}/${id}`, {
                                    method: 'DELETE',
