...
@section('page_title', 'Family Case Information')
    ...
    <div class="p-4 sm:p-6 w-full">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                ...
                <p class="text-sm text-neutral-500 mt-0.5">Macluumaadka Dacwada Qoyska</p>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden mb-6">
            ...
            <div class="px-6 py-4 border-b border-neutral-100 flex items-center gap-2">
                ...
                <span class="text-xs font-black uppercase tracking-[2px] text-neutral-500">Macluumaadka Dacwada Qoyska</span>
            </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex items-center gap-2">
                        @if($case->lower_court && $case->lower_case_no && $case->parties->count() === 0)
                            <form method="POST" action="{{ route('appeal-family-registration.import-parties', $case->AFCID) }}"
                        ...
                        @endif
                        <a href="{{ route('appeal-family-parties.index', ['case_id' => $case->AFCID]) }}"
                            class="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-white rounded-lg transition hover:opacity-90"
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden mb-6">
            ...
            <div class="px-6 py-4 border-b border-neutral-100 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('appeal-family-documents.index', ['case_id' => $case->AFCID]) }}"
                        class="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-white rounded-lg transition hover:opacity-90"
                        style="background:#528CBE">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden mb-6">
            ...
            <div class="px-6 py-4 border-b border-neutral-100 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('appeal-family-lawyers.index', ['case_id' => $case->AFCID]) }}"
                        class="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-white rounded-lg transition hover:opacity-90"
                        style="background:#528CBE">
