    ...
    <div class="p-4 sm:p-6 w-full">
        ...
        <div class="flex items-center justify-between mb-3">
            <div>
                ...
                <p class="text-sm text-neutral-500 mt-0.5">Xogta Guud ee Dacwada Qoyska</p>
            </div>
            <div class="flex gap-3">
                <a href="{{ route('appeal-family-registration.supporting', $case->AFCID) }}"
        ...
        <div class="rounded-2xl shadow-sm border border-neutral-100 overflow-hidden divide-y divide-neutral-100">
            ...
            <div class="bg-white">
                <div class="px-6 py-4 border-b border-neutral-100 flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-xs font-black uppercase tracking-[2px] text-neutral-500">Dhinacyada Dacwada Qoyska</span>
                    </div>
            ...
            <div class="bg-white">
                <div class="px-6 py-4 border-b border-neutral-100 flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-xs font-black uppercase tracking-[2px] text-neutral-500">Warqadaha Dacwada Qoyska</span>
                    </div>
            ...
            <div class="bg-white">
                <div class="px-6 py-4 border-b border-neutral-100 flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-xs font-black uppercase tracking-[2px] text-neutral-500">Gal ku Qorista Dacwada Qoyska</span>
                    </div>
                </div>
            ...
            <div class="bg-white">
                <div class="px-6 py-4 border-b border-neutral-100 flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-xs font-black uppercase tracking-[2px] text-neutral-500">Mudeynta Dacwada Qoyska</span>
                    </div>
                        ...
                        <tbody class="divide-y divide-neutral-100">
                            @forelse($case->hearings->sortBy('hearing_date') as $hearing)
                                ...
                                <tr class="hover:bg-neutral-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <a href="{{ route('appeal-family-hearings.document', $hearing->id) }}"
            ...
            <div class="bg-white">
                <div class="px-6 py-4 border-b border-neutral-100 flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-xs font-black uppercase tracking-[2px] text-neutral-500">Dhageysi Dacwada Qoyska</span>
                    </div>
                        ...
                        <tbody class="divide-y divide-neutral-100">
                            @forelse($scriptures as $scripture)
                                ...
                                <tr class="hover:bg-neutral-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <a href="{{ route('appeal-family-hearings.scripture.document', $scripture->id) }}"
            ...
            @if($case->lower_case_no)
                @include('appeal_court.Appeal_family.registration.partials.lower_court_information')
            @endif
