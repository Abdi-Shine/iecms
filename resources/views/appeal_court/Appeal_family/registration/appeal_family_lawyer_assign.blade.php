        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('lawyerManager', () => ({
                ...
                async loadAssignments() {
                    try {
                        const res = await fetch(`/appeal-family-lawyers/case/${this.caseId}`);
                ...
                async saveAssignments() {
                    ...
                    try {
                        for (let entry of this.entries) {
                            const url = entry.id ? `/appeal-family-lawyers/${entry.id}` : '/appeal-family-lawyers';
                ...
                async deleteAssignment(id) {
                    ...
                    if (result.isConfirmed) {
                        try {
                            const res = await fetch(`/appeal-family-lawyers/${id}`, {
                                method: 'DELETE',
