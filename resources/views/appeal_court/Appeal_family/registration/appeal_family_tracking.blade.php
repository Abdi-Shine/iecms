...
@section('page_title', 'Family Case Tracking')
@section('admin_main_content')
    ...
    <div class="p-4 sm:p-6 w-full">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-2xl font-bold text-neutral-800 tracking-tight">Family Case Tracking</h1>
                <p class="text-sm text-neutral-500 mt-0.5">Monitor all family cases — parties, judges, handovers, and status at a glance</p>
            </div>
        </div>

        {{-- KPI Cards --}}
        <div class="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
            <a href="{{ route('appeal-family-tracking.index', array_merge(request()->except(['status', 'page']), ['status' => 'all'])) }}"
            ...
            <a href="{{ route('appeal-family-tracking.index', array_merge(request()->except(['status', 'page']), ['status' => 'Active'])) }}"
            ...
            <a href="{{ route('appeal-family-tracking.index', array_merge(request()->except(['status', 'page']), ['status' => 'Sug Qaatay'])) }}"
            ...
            <a href="{{ route('appeal-family-tracking.index', array_merge(request()->except(['status', 'page']), ['status' => 'Qaatay'])) }}"
            ...
            <a href="{{ route('appeal-family-tracking.index', array_merge(request()->except(['status', 'page']), ['status' => 'Closed'])) }}"
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden">
            ...
            <div class="px-6 pt-5 pb-4 border-b border-neutral-100">
                <form action="{{ route('appeal-family-tracking.index') }}" method="GET"
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-24 text-center">
                                    <div class="flex flex-col items-center gap-4">
                                        ...
                                        <p class="text-neutral-400 font-semibold text-sm">No family cases found.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
