...
@section('page_title', 'Caddaynta Iyo Wareysiyada — ' . $case->case_number)
    ...
    <div class="p-4 sm:p-6 w-full">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 p-6 mb-6">
            ...
            <div class="flex items-center gap-6 mt-5 flex-wrap">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-xs font-bold px-3 py-1 rounded-full text-white bg-primary-400">Caddaynta Iyo Wareysiyada</span>
                </div>
                <div class="flex items-center gap-2">
        ...
        <div class="rounded-2xl p-5 mb-6 flex items-start gap-3"
            ...
            <div>
                ...
                <p class="text-sm text-neutral-600">Wareysi ka qaad iyo maarey caddaynta</p>
        ...
        {{-- Required Forms --}}
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 p-6 mb-6">
            <h2 class="text-base font-bold text-neutral-800 mb-4">Foomamka Loo Baahan Yahay ee Caddaynta Iyo Wareysiyada</h2>
            ...
            <div class="px-6 py-4 border-b border-neutral-100 flex items-center justify-between flex-wrap gap-3">
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-neutral-500">Waraaqaha laga sameeyay foomamka wareysiga iyo maareynta caddaynta</p>
                    </div>
                </div>
