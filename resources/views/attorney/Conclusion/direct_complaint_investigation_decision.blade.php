...
@section('admin_main_content')
    ...
    <div class="p-4 sm:p-6 w-full">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 p-6 mb-6">
            ...
            <div class="flex items-center gap-6 mt-5 flex-wrap">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-xs font-bold px-3 py-1 rounded-full text-white bg-primary-400">Go'aanka
                        Baaritaanka</span>
                </div>
                <div class="flex items-center gap-2">
                    <span class="text-xs font-bold text-neutral-500 uppercase tracking-wide">Xaalada:</span>
                    <span
                        class="text-xs font-bold px-3 py-1 rounded-full text-white {{ $isComplete ? 'bg-success-600' : 'bg-neutral-500' }}">
        ...
        {{-- Required Forms --}}
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 p-6 mb-6">
            <h2 class="text-base font-bold text-neutral-800 mb-4">Foomamka Loo Baahan Yahay ee Go'aanka Baaritaanka</h2>
            ...
            <div class="rounded-xl border border-neutral-200 p-5 max-w-sm">
                ...
                <h3 class="text-sm font-bold text-neutral-800">Go'aanka Baaritaanka</h3>
                <p class="text-xs text-primary-400 font-medium mt-1 mb-4">Go'aami haddii baaritaan loo baahan yahay</p>
                <a href="{{ route('attorney-cases.workflow.investigation-decision.form', $case->ACID) }}"
            ...
            <div class="px-6 py-4 border-b border-neutral-100 flex items-center justify-between flex-wrap gap-3">
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-neutral-500">Waraaqaha gudbinta CID ee laga sameeyay go'aannada baaritaanka
                        </p>
                    </div>
                </div>
                ...
                <table class="w-full text-left text-sm">
                    <thead>
                        <tr class="bg-neutral-50">
                            <th class="px-4 py-3 text-xs font-bold uppercase tracking-wider text-neutral-500">Nooca Waraaqda
                            </th>
                            <th class="px-4 py-3 text-xs font-bold uppercase tracking-wider text-neutral-500">Lambarka
                                Waraaqda</th>
                            <th class="px-4 py-3 text-xs font-bold uppercase tracking-wider text-neutral-500">Taariikhda
                            </th>
                            <th class="px-4 py-3 text-xs font-bold uppercase tracking-wider text-neutral-500">Maxkamadda
                            </th>
                            <th class="px-4 py-3 text-xs font-bold uppercase tracking-wider text-neutral-500">Xaalada</th>
                            <th class="px-4 py-3 text-xs font-bold uppercase tracking-wider text-neutral-500">Kii Sameeyay
                            </th>
                            <th class="px-4 py-3 text-xs font-bold uppercase tracking-wider text-neutral-500 text-center">
                                Ficilada</th>
                        </tr>
                    </thead>
                    <tbody>
