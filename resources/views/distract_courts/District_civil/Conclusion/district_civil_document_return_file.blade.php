    ...
    <div class="no-print doc-toolbar">
        ...
        <div class="doc-toolbar-actions">
            @if($returnFile)
                ...
                @endif
                <a href="{{ route('ReturnCivilFile.document-pdf', $case->CRID) }}" id="download-btn" class="btn-download" target="_blank">
    ...
    @if(!$returnFile)
        <div class="doc-wrapper">
            <div class="doc-empty">
                ...
                <a href="{{ route('ReturnCivilFile.create', $case->CRID) }}" class="btn-download">
