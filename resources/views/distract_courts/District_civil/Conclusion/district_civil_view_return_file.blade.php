    ...
    <div class="p-4 sm:p-6 w-full">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden">
            ...
            <div class="px-6 pt-5 pb-4 border-b border-neutral-100">
                <form action="{{ route('ReturnCivilFile.index') }}" method="GET"
                ...
                <table class="w-full text-left text-sm">
                    <thead>
                        <tr class="table-header-tint">
                            ...
                            <th class="px-6 py-3 text-xs font-bold uppercase tracking-wider text-neutral-500">Nooca Dacwada</th>
                            ...
                            <tr class="hover:bg-neutral-50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <a href="{{ route('ReturnCivilFile.create', $r->CRID) }}"
                                        ...
                                        {{-- Document button --}}
                                        @if($rf)
                                            <a href="{{ route('ReturnCivilFile.document', $r->CRID) }}"
