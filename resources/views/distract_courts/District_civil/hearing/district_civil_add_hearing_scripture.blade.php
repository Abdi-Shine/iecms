...
@section('admin_main_content')
    ...
    <div class="page-wrap">
        ...
        <div class="page-hd">
            ...
            <a href="{{ route('hearings.scripture') }}" class="btn-back">
                <i class="bi bi-arrow-left"></i> Dib ugu Noqo
            </a>
        </div>

        <form method="POST"
            action="{{ $scripture ? route('hearings.scripture.update', $scripture->id) : route('hearings.scripture.store') }}">
            @csrf
            ...
            <div class="form-actions">
                <a href="{{ route('hearings.scripture') }}" class="btn-cancel">
