...
<div class="no-print doc-toolbar">
    ...
    <div class="doc-toolbar-actions">
        @if($handover)
            ...
            @endif
            <a href="{{ route('civil-case-handover.document-pdf', $case->CRID) }}" id="download-btn" class="btn-download" target="_blank">
...
<div class="doc-wrapper">
    <div class="doc-empty">
        ...
        <a href="{{ route('civil-case-handover.create', $case->CRID) }}" class="btn-download">
