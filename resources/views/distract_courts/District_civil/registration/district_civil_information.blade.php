        ...
        <div class="rounded-2xl shadow-sm border border-neutral-100 overflow-hidden divide-y divide-neutral-100">
            ...
            <div class="bg-white">
                                ...
                                <tr class="hover:bg-neutral-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <a title="Rasiidka Lacag Bixinta"
                                            href="{{ route('civil-registration.payments.receipt', $payment->id) }}"
                                            target="_blank"
                ...
                <div class="px-6 py-4 border-t border-neutral-100">
                    <p class="text-xs text-neutral-400 font-medium">
                        Muujinaya <span
                            class="font-bold text-neutral-600">{{ $case->districtCivilPayments->count() }}</span>
                        ...
                        <table class="w-full text-left text-sm">
                            ...
                            <tbody class="divide-y divide-neutral-100">
                                <tr class="hover:bg-neutral-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('civil-case-handover.document-pdf', $case->CRID) }}" target="_blank"
                                            class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-semibold border transition-all"
                        ...
                        <table class="w-full text-left text-sm">
                            ...
                            <tbody class="divide-y divide-neutral-100">
                                <tr class="hover:bg-neutral-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('close_case.document.readonly', $case->CRID) }}"
                                            target="_blank"
                                            class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-semibold border transition-all"
                                            style="background:rgba(10,40,77,.07);border-color:rgba(10,40,77,.18);color:#0A284D"
                                            onmouseover="this.style.background='#0A284D';this.style.color='white'"
                        ...
                        <tbody class="divide-y divide-neutral-100">
                            @forelse($case->hearings->sortBy('hearing_date') as $hearing)
                                ...
                                <tr class="hover:bg-neutral-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <a href="{{ route('hearings.document-pdf', $hearing->id) }}" target="_blank"
                                            class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-semibold border transition-all"
                                            style="background:rgba(10,40,77,.07);border-color:rgba(10,40,77,.18);color:#0A284D"
                                            onmouseover="this.style.background='#0A284D';this.style.color='white'"
                                            onmouseout="this.style.background='rgba(10,40,77,.07)';this.style.color='#0A284D'">
                        ...
                        <tbody class="divide-y divide-neutral-100">
                            @forelse($scriptures as $scripture)
                                ...
                                <tr class="hover:bg-neutral-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <a href="{{ route('hearings.scripture.document', $scripture->id) }}"
                        ...
                        <tbody class="divide-y divide-neutral-100">
                            @forelse($judgments as $judgment)
                                ...
                                <tr class="hover:bg-neutral-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('judgments.document.readonly', $judgment->id) }}" target="_blank"
                            ...
                            <table class="w-full text-left text-sm">
                                ...
                                <tbody class="divide-y divide-neutral-100">
                                    ...
                                    <tr class="hover:bg-neutral-50 transition-colors">
                                        ...
                                        <td class="px-6 py-4">
                                            <a href="{{ route('ReturnCivilFile.document.readonly', $case->CRID) }}" target="_blank"
                                                class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-semibold border transition-all"
                                                style="background:rgba(10,40,77,.07);border-color:rgba(10,40,77,.18);color:#0A284D"
                                                onmouseover="this.style.background='#0A284D';this.style.color='white'"
                                                onmouseout="this.style.background='rgba(10,40,77,.07)';this.style.color='#0A284D'">
