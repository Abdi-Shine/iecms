        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('lawyerManager', () => ({
                ...
                async loadAssignments() {
                    try {
                        const res = await fetch(`/civil-case-lawyers/case/${this.caseId}`);
                ...
                editAssignment(assign) {
                    ...
                    this.entries = [{
                        id: assign.id,
                        civil_case_id: assign.civil_case_id,
                ...
                async saveAssignments() {
                    ...
                    try {
                        for (let entry of this.entries) {
                            const url = entry.id ? `/civil-case-lawyers/${entry.id}` : '/civil-case-lawyers';
                ...
                async deleteAssignment(id) {
                    ...
                    if (result.isConfirmed) {
                        try {
                            const res = await fetch(`/civil-case-lawyers/${id}`, {
                                method: 'DELETE',
