...
@section('admin_main_content')
    ...
    <div class="p-4 sm:p-6 w-full" x-data="returnFileManager()">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('criminal-return-file.index') }}" class="flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-neutral-600 border border-neutral-200
        ...
        function returnFileManager() {
            ...
            return {
                ...
                async save(status) {
                    ...
                    try {
                        const res = await fetch('{{ route('criminal-return-file.store') }}', {
                            method: 'POST',
                            headers: {
                        ...
                        if (res.ok && data.success) {
                            ...
                            if (isFinal) window.location.href = '{{ route('criminal-return-file.index') }}';
                        } else {
