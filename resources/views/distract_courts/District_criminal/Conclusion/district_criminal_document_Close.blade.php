...
<div class="no-print doc-toolbar">
    ...
    <div class="doc-toolbar-actions">
        ...
        @if($isStampApproved)
            <a href="{{ route('criminal-close-case.stamp-request', $case->CMID) }}"
...
<div id="judgment-doc" class="doc-page-multi">
    ...
    <div class="doc-body">
        ...
        <p class="doc-para doc-para-mt">
            Waxay u fadhiisatay dhageysiga dacwad ciqaabta ah ee summadeedu tahay:
            <strong>{{ $ref }},</strong>
...
function submitSign() {
    ...
    fetch('{{ route("document.sign", ["type" => "criminal_close_case", "id" => $judgment->id]) }}', {
        method: 'POST',
...
function submitStamp() {
    ...
    btn.disabled = true;
    btn.innerHTML = '<i class="bi bi-hourglass-split"></i> Sugaya...';
    fetch('{{ route("document.sign", ["type" => "criminal_close_case_stamp", "id" => $closeCase->id]) }}', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content') },
