...
@section('admin_main_content')
    ...
    <div class="no-print doc-toolbar">
        <div class="doc-toolbar-left">
            ...
            <div>
                <h1 class="doc-toolbar-title">Dhageysiga Dacwada Ciqaabta</h1>
        ...
        <div id="hearing-doc" class="doc-page-multi">
            ...
            <div class="doc-body">
                ...
                <p class="doc-para doc-para-mt">
                    ...
                    dhageysiga dacwad ciqaabta ah ee summadeedu tahay:
                    <strong>{{ $ref }},</strong>
    ...
    function submitSign() {
        ...
        fetch('{{ route("document.sign", ["type" => "criminal_scripture", "id" => $scripture->id]) }}', {
            method: 'POST',
