...
@section('admin_main_content')
    ...
    <div class="no-print doc-toolbar">
        <div class="doc-toolbar-left">
            ...
            <div>
                <h1 class="doc-toolbar-title">Mudeeyn Dacwad Ciqaabta</h1>
                <p class="doc-toolbar-sub">
                    Mudeeyn Dacwad Ciqaabta Ah · <span>{{ $case->FileNo }}</span>
                </p>
            </div>
        </div>
        <div class="doc-toolbar-actions">
            ...
            @endif
            @if($stampApproved)
                <a href="{{ route('criminal-hearings.approval.stamp', $hearing->id) }}"
            ...
            @endif
            <a href="{{ route('criminal-hearings.document-pdf', $hearing->id) }}" id="download-btn" class="btn-download" target="_blank">
    ...
    <div class="doc-wrapper" id="doc-wrapper">
        <div id="hearing-doc" class="doc-page-multi">
            ...
            <div class="doc-body">
                ...
                {{-- Title --}}
                <p class="doc-title">UJEEDDO: MUDEYN DACWAD CIQAABTA AH.</p>
    ...
    <script>
        ...
        function submitSign() {
            ...
            fetch('{{ route("document.sign", ["type" => "criminal_hearing", "id" => $hearing->id]) }}', {
                method: 'POST',
