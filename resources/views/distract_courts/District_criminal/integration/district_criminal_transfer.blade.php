...
@section('page_title', 'Wareejinta Dacwadaha Ciqaabta')
...
@section('admin_main_content')
    ...
    <div class="page-wrap">
        ...
        <div class="data-card">
            ...
            {{-- Search & Filter --}}
            <form action="{{ route('criminal-transfer.index') }}" method="GET" class="reg-filter">
                {{-- Page size --}}
                ...
                @if(request()->anyFilled(['search', 'status']))
                    <a href="{{ route('criminal-transfer.index') }}" class="act-btn" title="Clear" style="width:auto;padding:0 .9rem;gap:.4rem;">
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        @if(($isKaaliyeSare ?? false) && $isPending)
                                            <form method="POST" action="{{ route('criminal-transfer.approve', $trn->id) }}"
                                        ...
                                        @else
                                            <a href="{{ route('criminal-transfer.form', $r->CMID) }}"
