...
@section('admin_main_content')
    ...
    <div class="p-4 sm:p-6 w-full" x-data="handoverManager()">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('criminal-registration.handover') }}" class="flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-neutral-600 border border-neutral-200
        ...
        function handoverManager() {
            ...
            return {
                ...
                async save(status = 'Draft') {
                    this.saving = true;
                    try {
                        const res = await fetch('{{ route('criminal-case-handover.store') }}', {
                            method: 'POST',
                            headers: {
