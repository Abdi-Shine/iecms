...
@section('page_title', 'Diiwaan Dhaqdhaqaaqa Dacwadaha Ciqaabta — IECMS')
@section('admin_main_content')
    ...
    <div class="p-4 sm:p-6 w-full">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-2xl font-bold text-neutral-800 tracking-tight">Dhaqdhaqaaqa Dacwadaha Ciqaabta</h1>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden">
            ...
            <div class="px-6 pt-5 pb-4 border-b border-neutral-100">
                <form action="{{ route('criminal-registration.handover') }}" method="GET"
                            ...
                            <tr class="hover:bg-neutral-50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <div class="flex items-center justify-center gap-2">
                                        <a href="{{ route('criminal-case-handover.create', $r->CMID) }}"
                                        ...
                                        <a href="{{ route('criminal-case-handover.document', $r->CMID) }}"
                            ...
                            <tr>
                                <td colspan="8" class="px-6 py-20 text-center">
                                    <div class="flex flex-col items-center gap-3">
                                        ...
                                        <p class="text-neutral-400 font-medium text-sm">Dacwad ciqaabta lama helin.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
