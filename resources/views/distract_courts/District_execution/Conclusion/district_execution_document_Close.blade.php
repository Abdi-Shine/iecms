...
<div class="no-print doc-toolbar">
    ...
    <div class="doc-toolbar-actions">
        ...
        @if($isStampApproved)
            <a href="{{ route('execution-close-case.stamp-request', $case->ECID) }}"
...
<div id="judgment-doc" class="doc-page-multi">
    ...
    <div class="doc-body">
        ...
        <p style="text-align:center;font-weight:700;font-size:13px;margin-bottom:12px;letter-spacing:.04em">QAYBTA FULINTA</p>
        ...
        <p class="doc-title">QARAARKA DACWADA FULINTA</p>
...
function submitSign() {
    ...
    fetch('{{ route("document.sign", ["type" => "execution_close_case", "id" => $judgment->id]) }}', {
        method: 'POST',
...
function submitStamp() {
    ...
    btn.disabled = true;
    btn.innerHTML = '<i class="bi bi-hourglass-split"></i> Sugaya...';
    fetch('{{ route("document.sign", ["type" => "execution_close_case_stamp", "id" => $closeCase->id]) }}', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content') },
