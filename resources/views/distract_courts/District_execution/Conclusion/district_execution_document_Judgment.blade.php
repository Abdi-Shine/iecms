...
<div class="no-print doc-toolbar">
    ...
    <div class="doc-toolbar-actions">
        ...
        @if($isStampApproved)
            <a href="{{ route('execution-judgments.stamp-request', $judgment->id) }}"
...
<div id="judgment-doc" class="doc-page-multi">
    ...
    <div class="doc-body">
        ...
        <p class="doc-title">XUKUNKA DACWADA FULINTA</p>
        ...
        @else
            @if($judgment->judgment_body)
                <p class="section-title" style="text-align:center;margin-top:20px">XUKUNKA MAXKAMADDA</p>
                <div style="margin-top:16px;line-height:1.7;font-size:13px;text-align:justify;">{!! $judgment->judgment_body !!}</div>
            @endif
        @endif
...
function submitSign() {
    ...
    fetch('{{ route("document.sign", ["type" => "execution_judgment", "id" => $judgment->id]) }}', {
        method: 'POST',
