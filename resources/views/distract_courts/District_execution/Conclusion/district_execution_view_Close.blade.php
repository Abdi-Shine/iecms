...
@section('admin_main_content')
    ...
    <div class="page-wrap">
        ...
        <div class="data-card">
            ...
            {{-- Search & Filter --}}
            <form action="{{ route('execution-close-case.index') }}" method="GET" class="reg-filter">
                {{-- Page size --}}
                ...
                @if(request()->anyFilled(['search', 'status']))
                    <a href="{{ route('execution-close-case.index') }}" class="act-btn" title="Clear" style="width:auto;padding:0 .9rem;gap:.4rem;">
                    ...
                    <tbody>
                        @forelse($records as $i => $r)
                            @php
                                ...
                                $latestJudgment = \App\Models\DistrictExecutionJudgment::where('execution_case_id', $r->ECID)->orderByDesc('created_at')->first();
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        @else
                                            <a href="{{ route('execution-close-case.form', $r->ECID) }}" title="Fur Foomka Xidhitaanka"
                                                class="act-btn"
                                        ...
                                        {{-- Close case document --}}
                                        @if($latestJudgment)
                                            <a href="{{ route('execution-close-case.document', $r->ECID) }}" title="Dukuumintiga Xidhitaanka"
                                                class="act-btn"
                            ...
                            <tr>
                                <td colspan="9">
                                    <div class="empty-state">
                                        ...
                                        <p class="empty-msg">Dacwad fulinta ah la xidhay lama helin.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
