...
@section('admin_main_content')
    ...
    <div class="page-wrap">
        ...
        <div class="page-hd">
            <div class="page-hd-left">
                ...
                <div>
                    ...
                    <p class="page-sub">Maamul iyo diiwaangelinta xukunnada dacwadaha madaniga</p>
                </div>
            </div>
        </div>
        ...
        <div class="data-card">
            ...
            {{-- Search & Filter --}}
            <form action="{{ route('execution-judgments.index') }}" method="GET" class="reg-filter">
                {{-- Page size --}}
                ...
                @if(request()->anyFilled(['search', 'status']))
                    <a href="{{ route('execution-judgments.index') }}" class="act-btn" title="Clear" style="width:auto;padding:0 .9rem;gap:.4rem;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        @else
                                            <a href="{{ route('execution-judgments.create', $r->ECID) }}" title="Ku Dar Xukun"
                                                class="act-btn act-btn-poa">
                                                <i class="bi bi-gavel"></i>
                                            </a>
                                        @endif
                                        @if($latestJudgment && $latestJudgment->status === 'Draft')
                                            <a href="{{ route('execution-judgments.edit', $latestJudgment->id) }}"
                                        ...
                                        @endif
                                        @if($latestJudgment)
                                            <a href="{{ route('execution-judgments.document', $latestJudgment->id) }}" target="_blank"
