...
@section('admin_main_content')
    ...
    <div class="page-wrap">
        ...
        <div class="data-card">
            ...
            {{-- Search & Filter --}}
            <form action="{{ route('execution-judgments.receipts') }}" method="GET" class="reg-filter">
                {{-- Page size --}}
                ...
                @if(request()->anyFilled(['search', 'status']))
                    <a href="{{ route('execution-judgments.receipts') }}" class="act-btn" title="Clear" style="width:auto;padding:0 .9rem;gap:.4rem;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        @endif
                                        <a href="{{ route('execution-registration.show', $r->ECID) }}" title="Arag Dacwada"
    ...
    <script>
        ...
        function confirmReceipt(judgmentId, partyId) {
            ...
            fetch('/execution-judgment-receipts/' + judgmentId + '/' + partyId, {
                method: 'POST',
        ...
        function saveEditForm(judgmentId, pid) {
            ...
            fetch('/execution-judgment-receipts/' + judgmentId + '/' + pid, {
                method: 'POST',
                headers: { 'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content },
                body: fd
            })
