    ...
    <div class="p-4 sm:p-6 w-full">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden">
            ...
            <div class="px-6 pt-5 pb-4 border-b border-neutral-100">
                <form action="{{ route('execution.hearing.cases') }}" method="GET"
                            ...
                            <tr class="hover:bg-neutral-50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center gap-2">
                                        <a href="{{ route('execution-hearings.document.case', $r->ECID) }}"
                                        ...
                                        <a href="{{ route('execution-hearings.create', $r->ECID) }}" title="Mudee Dacwada"
                                            class="w-8 h-8 flex items-center justify-center rounded-lg border border-neutral-200 text-neutral-400 transition-all"
                            ...
                            <tr>
                                <td colspan="8" class="px-6 py-20 text-center">
                                    <div class="flex flex-col items-center gap-3">
                                        ...
                                        <p class="text-neutral-400 font-medium text-sm">Wax dacwado fulinta ah lama helin.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
