    ...
    <div class="p-4 sm:p-6 w-full" x-data="{
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                ...
                <p class="text-sm text-neutral-500 mt-0.5">Macluumaadka Dacwada Fulinta</p>
            </div>
            <div class="flex gap-3">
                <a href="{{ route('execution-case-assign.index') }}" class="flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-neutral-600 border border-neutral-200
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden mb-6">
            ...
            <div class="px-6 py-4 border-b border-neutral-100 flex items-center gap-2">
                ...
                <span class="text-xs font-black uppercase tracking-[2px] text-neutral-500">Macluumaadka Dacwada Fulinta</span>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden mb-6">
            ...
            <div class="px-6 py-4 border-b border-neutral-100 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('execution-registration.payment-request', $case->ECID) }}"
                    ...
                    <tbody class="divide-y divide-neutral-100">
                        @forelse($case->payments as $index => $payment)
                            ...
                            <tr class="hover:bg-neutral-50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a title="Rasiidka Lacag Bixinta" href="{{ route('execution-registration.payments.receipt', $payment->id) }}" target="_blank"
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden mb-6">
            ...
            <div class="px-6 py-4 border-b border-neutral-100 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('execution-case-parties.index', ['case_id' => $case->ECID]) }}"
                        class="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-white rounded-lg transition hover:opacity-90"
                        style="background:#528CBE">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden mb-6">
            ...
            <div class="px-6 py-4 border-b border-neutral-100 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('execution-case-documents.index', ['case_id' => $case->ECID]) }}"
                        class="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-white rounded-lg transition hover:opacity-90"
                        style="background:#528CBE">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden mb-6">
            ...
            <div class="px-6 py-4 border-b border-neutral-100 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('execution-case-lawyers.index', ['case_id' => $case->ECID]) }}"
                        class="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-white rounded-lg transition hover:opacity-90"
                        style="background:#528CBE">
