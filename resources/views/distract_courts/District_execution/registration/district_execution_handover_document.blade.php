...
<div class="no-print doc-toolbar">
    ...
    <div class="doc-toolbar-actions">
        @if($handover)
            ...
            @endif
            <a href="{{ route('execution-case-handover.document-pdf', $case->ECID) }}" id="download-btn" class="btn-download" target="_blank">
...
<div class="doc-wrapper">
    <div class="doc-empty">
        ...
        <a href="{{ route('execution-case-handover.create', $case->ECID) }}" class="btn-download">
...
function submitSign() {
    ...
    fetch('{{ route("document.sign", ["type" => "execution_handover", "id" => $handover?->id ?? 0]) }}', {
        method: 'POST',
