        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('lawyerManager', () => ({
                ...
                async loadAssignments() {
                    try {
                        const res = await fetch(`/execution-case-lawyers/case/${this.caseId}`);
                ...
                editAssignment(assign) {
                    ...
                    this.entries = [{
                        id: assign.id,
                        execution_case_id: assign.execution_case_id,
                ...
                async saveAssignments() {
                    ...
                    try {
                        for (let entry of this.entries) {
                            const url = entry.id ? `/execution-case-lawyers/${entry.id}` : '/execution-case-lawyers';
                ...
                async deleteAssignment(id) {
                    ...
                    if (result.isConfirmed) {
                        try {
                            const res = await fetch(`/execution-case-lawyers/${id}`, {
                                method: 'DELETE',
