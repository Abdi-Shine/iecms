...
@section('page_title', 'Rafcaanka Dacwadaha')
...
@section('admin_main_content')
    ...
    @if(session('success'))
        <div
            style="background:rgba(16,185,129,.1);border:1px solid rgba(16,185,129,.3);color:#065f46;
    ...
    <div class="page-wrap">
        ...
        <div class="page-hd">
            <div class="page-hd-left">
                <div class="page-hd-icon"><i class="bi bi-arrow-up-circle"></i></div>
                <div>
                    <h1 class="page-title">Rafcaanka Dacwadaha</h1>
                    <p class="page-sub">Maamul iyo diiwaangelinta rafcaanka xukunnada dacwadaha madaniga</p>
                </div>
            </div>
        </div>
        ...
        <div class="kpi-grid">
            ...
            <div class="kpi-card">
                ...
                <div>
                    ...
                    <p class="kpi-sub-gold">Rafcaan socota</p>
                </div>
            </div>
            <div class="kpi-card">
                <div class="kpi-ico kpi-ico-success"><i class="bi bi-hammer"></i></div>
                <div>
                    <p class="kpi-lbl">Dhaqan Gal</p>
                    <h3 class="kpi-val">{{ $stats['dhaqanGal'] }}</h3>
        ...
        <div class="data-card">
            ...
            {{-- Search & Filter --}}
            <form action="{{ route('execution-case-appeal.index') }}" method="GET" class="reg-filter">
                {{-- Page size --}}
                ...
                @if(request()->anyFilled(['search', 'status']))
                    <a href="{{ route('execution-case-appeal.index') }}" class="act-btn" title="Clear" style="width:auto;padding:0 .9rem;gap:.4rem;">
                ...
                <table class="data-table">
                    <thead>
                        <tr>
                            ...
                            <th>Rafcaansaday</th>
                            <th>Xaalada</th>
                            <th class="center" style="width:8rem">Ficilada</th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        @else
                                            <a href="{{ route('execution-case-appeal.form', $r->ECID) }}" title="Fur Foomka Rafcaanka"
                                                class="act-btn"
                                                style="background:rgba(240,180,60,.1);color:#92600a;border:1px solid rgba(240,180,60,.35)">
                                                <i class="bi bi-arrow-up-circle"></i>
                                            </a>
                                        @endif

                                        <a href="{{ route('execution-registration.show', $r->ECID) }}" title="Arag Dacwada Oo Dhan"
                            ...
                            <tr>
                                <td colspan="8">
                                    <div class="empty-state">
                                        <div class="empty-ico"><i class="bi bi-arrow-up-circle"></i></div>
                                        <p class="empty-msg">Dacwad fulinta ah rafcaan ah lama helin.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
