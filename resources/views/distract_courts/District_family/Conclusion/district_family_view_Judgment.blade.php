...
@section('admin_main_content')
    ...
    <div class="page-wrap">
        ...
        <div class="data-card">
            ...
            {{-- Search & Filter --}}
            <form action="{{ route('family-judgments.index') }}" method="GET" class="reg-filter">
                {{-- Page size --}}
                ...
                @if(request()->anyFilled(['search', 'status']))
                    <a href="{{ route('family-judgments.index') }}" class="act-btn" title="Clear" style="width:auto;padding:0 .9rem;gap:.4rem;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        @else
                                            <a href="{{ route('family-judgments.create', $r->FCID) }}" title="Ku Dar Xukun"
                                                class="act-btn act-btn-poa">
                                                <i class="bi bi-gavel"></i>
                                            </a>
                                        @endif
                                        @if($latestJudgment && $latestJudgment->status === 'Draft')
                                            <a href="{{ route('family-judgments.edit', $latestJudgment->id) }}"
                                        ...
                                        @endif
                                        @if($latestJudgment)
                                            <a href="{{ route('family-judgments.document', $latestJudgment->id) }}" target="_blank"
