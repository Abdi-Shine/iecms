...
@section('admin_main_content')
    ...
    <div class="page-wrap">
        ...
        <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:1.5rem">
            ...
            <a href="{{ route('family-case-appeal.index') }}" class="btn-back">
                <i class="bi bi-arrow-left"></i> Dib ugu Noqo
            </a>
        </div>

        <form method="POST" action="{{ route('family-case-appeal.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-actions">
                <a href="{{ route('family-case-appeal.index') }}" class="btn-cancel">
