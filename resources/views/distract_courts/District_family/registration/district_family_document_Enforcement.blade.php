...
@section('admin_main_content')
    ...
    <div class="no-print doc-toolbar">
        <div class="doc-toolbar-left">
            ...
            <div>
                <h1 class="doc-toolbar-title">Dhaqan Galka Dacwadda Qoyska</h1>
    ...
    <div class="doc-wrapper" id="doc-wrapper">
        <div id="enforcement-doc" class="doc-page-multi">
            ...
            <div class="doc-body">
                ...
                {{-- Subject --}}
                <p class="doc-title">Ujeedo: Dhaqan Galka Dacwadda Qoyska</p>

                {{-- Intro --}}
                <p class="doc-para">
                    Maxkamadu waxay bilowday dhaqan galka go'aankii dacwadda qoyska
