                                ...
                                <tr class="hover:bg-neutral-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <a title="Rasiidka Lacag Bixinta"
                                            href="{{ route('family-registration.payments.receipt', $payment->id) }}"
                                            target="_blank"
                        ...
                        <table class="w-full text-left text-sm">
                            ...
                            <tbody class="divide-y divide-neutral-100">
                                <tr class="hover:bg-neutral-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('family-case-handover.document-pdf', $case->FCID) }}" target="_blank"
                                            class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-semibold border transition-all"
                        ...
                        <table class="w-full text-left text-sm">
                            ...
                            <tbody class="divide-y divide-neutral-100">
                                <tr class="hover:bg-neutral-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('family-close-case.document.readonly', $case->FCID) }}"
                                            target="_blank"
                                            class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-semibold border transition-all"
                                            style="background:rgba(10,40,77,.07);border-color:rgba(10,40,77,.18);color:#0A284D"
                                            onmouseover="this.style.background='#0A284D';this.style.color='white'"
                        ...
                        <tbody class="divide-y divide-neutral-100">
                            @forelse($case->hearings->sortBy('hearing_date') as $hearing)
                                ...
                                <tr class="hover:bg-neutral-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <a href="{{ route('family-hearings.document-pdf', $hearing->id) }}" target="_blank"
                                            class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-semibold border transition-all"
                                            style="background:rgba(10,40,77,.07);border-color:rgba(10,40,77,.18);color:#0A284D"
                                            onmouseover="this.style.background='#0A284D';this.style.color='white'"
                                            onmouseout="this.style.background='rgba(10,40,77,.07)';this.style.color='#0A284D'">
                        ...
                        <tbody class="divide-y divide-neutral-100">
                            @forelse($judgments as $judgment)
                                ...
                                <tr class="hover:bg-neutral-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('family-judgments.document.readonly', $judgment->id) }}" target="_blank"
                            ...
                            <table class="w-full text-left text-sm">
                                ...
                                <tbody class="divide-y divide-neutral-100">
                                    ...
                                    <tr class="hover:bg-neutral-50 transition-colors">
                                        ...
                                        <td class="px-6 py-4">
                                            <a href="{{ route('family-return-file.document.readonly', $case->FCID) }}" target="_blank"
                                                class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-semibold border transition-all"
                                                style="background:rgba(10,40,77,.07);border-color:rgba(10,40,77,.18);color:#0A284D"
                                                onmouseover="this.style.background='#0A284D';this.style.color='white'"
                                                onmouseout="this.style.background='rgba(10,40,77,.07)';this.style.color='#0A284D'">
    ...
    @push('scripts')
        <script>
            function deleteDocument(id) {
                ...
                fetch(`/family-case-documents/${id}`, {
                    method: 'DELETE',
                    headers: {
