...
@section('page_title', isset($record) ? 'Edit Family Case — Family Registry' : 'Diiwaanka Dacwada Qoyska — Family Registry')
...
<div class="p-4 sm:p-6 w-full" x-data="{
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-neutral-800 tracking-tight">
                {{ $isEditMode ? 'Edit Family Case' : 'Diiwaanka Dacwada Qoyska' }}
            </h1>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden">
        ...
        <form action="{{ $isEditMode ? route('family-registration.update', $record->FCID) : route('family-registration.store') }}"
                ...
                <div class="rounded-2xl border p-4 flex items-center gap-3" style="background:linear-gradient(135deg,#eef4fb,#e8f0f9);border-color:#c3d9f0">
                    ...
                    <div>
                        <p class="text-sm font-semibold" style="color:#0A284D">
                            Lambarka Dacwada Qoyska:&nbsp;<span x-text="fileNo" class="text-base font-black tracking-wide" style="color:#0A284D"></span>
                        </p>
            ...
            <input type="hidden" name="CaseType" value="Qoyska">
            ...
            <input type="hidden" name="LegalBasis" value="Dacwadda Qoyska">
