...
@section('admin_main_content')
    ...
    <div class="page-wrap">
        ...
        <div class="data-card">
            ...
            {{-- Search & Filter --}}
            <form action="{{ route('family-enforcement.index') }}" method="GET" class="reg-filter">
                {{-- Page size --}}
                ...
                @if(request()->anyFilled(['search', 'status']))
                    <a href="{{ route('family-enforcement.index') }}" class="act-btn" title="Clear" style="width:auto;padding:0 .9rem;gap:.4rem;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="td-actions">
                                        ...
                                        @else
                                            <a href="{{ route('family-enforcement.form', $r->FCID) }}" title="Fur Foomka Dhaqan Galka"
                                                class="act-btn"
                                        ...
                                        @if($enf)
                                            <a href="{{ route('family-enforcement.document', $r->FCID) }}" target="_blank"
                            ...
                            <tr>
                                <td colspan="9">
                                    <div class="empty-state">
                                        ...
                                        <p class="empty-msg">Dacwad qoyska ah dhaqan gal ah lama helin.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
