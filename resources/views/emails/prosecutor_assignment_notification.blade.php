...
<head>
    ...
    <title>Ogeysiis — Xilsaarista Xeer Ilaaliye</title>
</head>
            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);max-width:600px;width:100%">
                ...
                <tr>
                    <td style="background:#0A284D;padding:32px 40px;text-align:center">
                        ...
                        <h1 style="color:#ffffff;font-size:20px;font-weight:700;margin:0 0 6px">ATTORNEY GENERAL OFFICE</h1>
                        <p style="color:rgba(255,255,255,0.7);font-size:13px;margin:0">Ogeysiis Rasmi ah — Official Notice</p>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding:36px 40px">
                        ...
                        <p style="font-size:15px;color:#374151;margin:0 0 20px">
                            Mudane / Marwo Xeer Ilaaliye <strong style="color:#0A284D">{{ $prosecutorName }}</strong>,
                        </p>
                        ...
                        <p style="font-size:14px;color:#4b5563;line-height:1.8;margin:0 0 16px">
                            Waxaa si rasmi ah laguugu wargelinayaa in aad tahay
                            <strong style="color:#0A284D">{{ $roleLabel }}</strong> ee dacwaddan cabashada toosan ah:
                            <strong style="color:#0A284D">{{ $caseTitle }}</strong>.
                            Fadlan si degdeg ah ula soco faahfaahinta dacwadda si aad u diyaariso baaritaanka
                            iyo eedeynta u baahan.
                        </p>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td style="padding:6px 0;border-bottom:1px solid rgba(82,140,190,0.15)">
                                                ...
                                                <span style="font-size:14px;font-weight:800;color:#0A284D">{{ $caseNumber }}</span>
                                            </td>
                                            <td style="padding:6px 0;border-bottom:1px solid rgba(82,140,190,0.15);text-align:right">
                                                <span style="font-size:11px;font-weight:700;color:#528CBE;text-transform:uppercase;letter-spacing:.05em">Xilka</span><br>
                                                <span style="font-size:14px;font-weight:800;color:#0A284D">{{ $roleLabel }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding:6px 0 0" colspan="2">
                                                <span style="font-size:11px;font-weight:700;color:#528CBE;text-transform:uppercase;letter-spacing:.05em">Taariikhda La Xilsaaray</span><br>
                                                <span style="font-size:14px;font-weight:800;color:#0A284D">{{ $assignedDate }}</span>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td style="background:rgba(82,140,190,0.08);border-left:4px solid #528CBE;border-radius:0 8px 8px 0;padding:16px 20px">
                                    <p style="font-size:13px;color:#374151;margin:0;line-height:1.7">
                                        ...
                                        fadlan la xiriir <strong>Xafiiska Diiwaangelinta ee Xeer Ilaaliyaha Guud</strong>.
                                    </p>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td style="background:#f9fafb;border-top:1px solid #e5e7eb;padding:24px 40px;text-align:center">
                        ...
                        <p style="font-size:11px;color:#d1d5db;margin:0">
                            Warqaddan waa mid rasmi ah — This is an official notification
                        </p>
                    </td>
                </tr>
